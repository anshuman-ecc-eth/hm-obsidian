...
1. Click **Options**.
2. Go to **Hyvmind/Settings/Wallet/Obsidian** to copy your Principal ID.
...
1. If your binding is compromised or corrupted for some reason, revoke it from Hyvmind's **Settings** page and bind afresh.
2. Your uploads will show up in Hyvmind's **Notes** section. From there, you can edit or convert them into extensible Graphs.
3. To view your Hyvmind notes in Obsidian, download and add them to your target Vault.
